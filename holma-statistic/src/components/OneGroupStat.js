                    ...
                    <Card style={{backgroundColor: "#F4F6F8"}}>
                        <CardContent>
                            ...
                            <Typography style={{fontSize: 18}}>
                                {amountEntry.count} Artikel gekauft
                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
        ...
        <React.Fragment>  
            <Grid 
                ...
                <Grid item xs={12} sm={4} style={{paddingLeft: 20, paddingRight: 20, paddingTop: 10, paddingBottom: 10}}>
                    <Typography align="left" className="title" style={{fontSize: 16, fontWeight: "bold", color: colors.teal[600]}}>Das ist die Statistik der Gruppe {this.state.groupId}:</Typography>
                </Grid>
                <Grid item xs={9} sm={6} style={{paddingLeft: 20, paddingRight: 20, paddingTop: 10, paddingBottom: 10}}>
                    <Typography align="right" className="title" style={{fontSize: 16, fontWeight: "bold"}}>Häufigste Artikel</Typography>
                </Grid>
